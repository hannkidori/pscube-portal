...
# 機種スペック（キングハナハナ-30）
COIN_PER_GAME = 50 / 39.9
BIG_COINS = 312
REG_COINS = 130

# 設定確率 (設定1〜6)
SETTINGS = ["設定1", "設定2", "設定3", "設定4", "設定5", "設定6"]
PROB_BIG = [1/292.5, 1/283.7, 1/273.0, 1/260.0, 1/246.3, 1/232.3]
PROB_REG = [1/482.2, 1/452.0, 1/420.1, 1/385.5, 1/348.5, 1/318.1]
...
for target_file in html_files:
    try:
        ...
        machine_name = title.split("｜")[-1] if "｜" in title else "キングハナハナ-30"
